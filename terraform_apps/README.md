...
| <a name="requirement_portainer"></a> [portainer](#requirement\_portainer) | 1.25.2 |
...
| <a name="provider_portainer"></a> [portainer](#provider\_portainer) | 1.25.2 |
...
| [portainer_environment.remote_qnap](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/environment) | resource |
| [portainer_stack.alloy](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.backup](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.beszel](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.beszel_agent_qnap](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.cloudflared](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.dozzle](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.filebrowser](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.gatus](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.glance](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.homepage](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.immich](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.jellyfin](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.jellyseerr](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.linkwarden](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.maintenance](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.nzbget](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.otterwiki](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.plex](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.prowlarr](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.radarr](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.socket-proxy](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.sonarr](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.traefik](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.wallos](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
| [portainer_stack.whoami](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/resources/stack) | resource |
...
| [portainer_environment.local_swarm](https://registry.terraform.io/providers/portainer/portainer/1.25.2/docs/data-sources/environment) | data source |
...
| <a name="input_knowledgeops_api_replicas"></a> [knowledgeops\_api\_replicas](#input\_knowledgeops\_api\_replicas) | Number of API service replicas | `string` | `"2"` | no |
| <a name="input_knowledgeops_db_name"></a> [knowledgeops\_db\_name](#input\_knowledgeops\_db\_name) | KnowledgeOps database name | `string` | `"knowledgeops"` | no |
| <a name="input_knowledgeops_db_password"></a> [knowledgeops\_db\_password](#input\_knowledgeops\_db\_password) | KnowledgeOps database password | `string` | n/a | yes |
| <a name="input_knowledgeops_db_user"></a> [knowledgeops\_db\_user](#input\_knowledgeops\_db\_user) | KnowledgeOps database user | `string` | `"knowledgeops"` | no |
| <a name="input_knowledgeops_domain"></a> [knowledgeops\_domain](#input\_knowledgeops\_domain) | KnowledgeOps domain (e.g., your-domain.com) | `string` | n/a | yes |
| <a name="input_knowledgeops_environment"></a> [knowledgeops\_environment](#input\_knowledgeops\_environment) | KnowledgeOps environment (dev/staging/production) | `string` | `"production"` | no |
| <a name="input_knowledgeops_frontend_replicas"></a> [knowledgeops\_frontend\_replicas](#input\_knowledgeops\_frontend\_replicas) | Number of Frontend service replicas | `string` | `"2"` | no |
| <a name="input_knowledgeops_github_client_id"></a> [knowledgeops\_github\_client\_id](#input\_knowledgeops\_github\_client\_id) | GitHub OAuth Client ID (from project-kops Doppler) | `string` | `""` | no |
| <a name="input_knowledgeops_github_client_secret"></a> [knowledgeops\_github\_client\_secret](#input\_knowledgeops\_github\_client\_secret) | GitHub OAuth Client Secret (from project-kops Doppler) | `string` | `""` | no |
| <a name="input_knowledgeops_jwt_secret_key"></a> [knowledgeops\_jwt\_secret\_key](#input\_knowledgeops\_jwt\_secret\_key) | JWT Secret Key (from project-kops Doppler) | `string` | n/a | yes |
| <a name="input_knowledgeops_llm_model"></a> [knowledgeops\_llm\_model](#input\_knowledgeops\_llm\_model) | LLM model | `string` | `"gpt-4o"` | no |
| <a name="input_knowledgeops_llm_provider"></a> [knowledgeops\_llm\_provider](#input\_knowledgeops\_llm\_provider) | LLM provider | `string` | `"openai"` | no |
| <a name="input_knowledgeops_openai_api_key"></a> [knowledgeops\_openai\_api\_key](#input\_knowledgeops\_openai\_api\_key) | OpenAI API key (from project-kops Doppler) | `string` | n/a | yes |
| <a name="input_knowledgeops_redis_password"></a> [knowledgeops\_redis\_password](#input\_knowledgeops\_redis\_password) | KnowledgeOps Redis password | `string` | n/a | yes |
| <a name="input_knowledgeops_slack_webhook_url"></a> [knowledgeops\_slack\_webhook\_url](#input\_knowledgeops\_slack\_webhook\_url) | Slack Webhook URL for notifications (from project-kops Doppler, optional) | `string` | `""` | no |
| <a name="input_knowledgeops_worker_replicas"></a> [knowledgeops\_worker\_replicas](#input\_knowledgeops\_worker\_replicas) | Number of Worker service replicas | `string` | `"1"` | no |
